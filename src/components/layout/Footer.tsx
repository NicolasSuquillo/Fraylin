  ...
  return (
    <footer className="bg-neutral-dark text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-5">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group w-9 h-9 bg-white/10 hover:bg-brand-primary rounded-lg flex items-center justify-center transition-colors text-white hover:text-neutral-dark"
                aria-label="Facebook"
              >
        ...
        <div className="border-t border-brand-primary/20 mt-10 pt-6 text-center">
          <p className="text-accent-cream/30 text-sm">
